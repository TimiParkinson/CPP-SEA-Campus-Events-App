/**
 * Mock data copied from seed.ts, representing the current state of the database.
 * Used while DATABASE_URL isn't available
 */
...
export const seedMock = {
	...
	organizations: [
		{
			...
			description:
				'A community for students interested in software development, algorithms, and tech careers',
		...
		},
		{
			...
			contactEmail: 'latindance@university.edu',
			isActive: true
		},
		{
			name: 'Environmental Action Coalition',
			description:
				'Students working together for campus sustainability and environmental awareness',
			contactEmail: 'eac@university.edu',
			isActive: true
		},
		{
			name: 'Intramural Soccer League',
			description: 'Competitive and recreational soccer for all skill levels',
			contactEmail: 'soccer@university.edu',
			isActive: true
		},
		{
			name: 'Board Game Club',
			description: 'Weekly meetups to play strategy games, party games, and tabletop RPGs',
			contactEmail: 'boardgames@university.edu',
			isActive: true
		},
		{
	...
	events: [
		...
		},
		{
			...
			description:
				'Help us make our campus beautiful! Volunteer for our monthly cleanup event. Supplies and refreshments provided.',
		...
		},
		{
			...
			description:
				'Get ready for the upcoming career fair! Resume reviews, interview tips, and networking strategies.',
		...
		},
		{
			...
			description:
				'Championship game of the fall intramural season! Come support your favorite team.',
			location: 'West Field',
		...
		},
		{
			...
			description:
				'Weekly game night! This week featuring Catan, Ticket to Ride, and Codenames. All experience levels welcome.',
		...
		},
		{
			...
			description:
				'Learn how to craft a compelling resume that gets interviews. Bring your laptop for hands-on editing.',
		...
		},
		{
			...
			description:
				'Dr. Maria Santos from the Environmental Science Department discusses local climate action. Q&A to follow.',
		...
		},
		{
			...
			description:
				'24-hour coding marathon! Form teams, build projects, compete for prizes. Pizza and energy drinks provided.',
		...
		},
		{
			...
			description:
				'Starting a new D&D 5e campaign! New players welcome, characters will be created together.',
			location: 'Student Lounge, 2nd Floor',
		...
		},
		{
			...
			description:
				'Bring your old electronics for responsible recycling. Accepting phones, laptops, cables, and more.',
